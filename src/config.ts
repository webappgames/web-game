...
export const BLOCKS_DEFAULT = [new Block(undefined, new Vector3(0, 0, 0), '#cccccc')];
...
export const PALETTE_COMMON = ['#ffffff', '#000000', '#74ffaa', '#ffb075'];

export const PALETTE_GROUND = [COLOR_GROUND, '#3dff55', '#ccff7c'];
export const PALETTE_SKY = [COLOR_SKY, '#55fff0', '#eafeff'];
